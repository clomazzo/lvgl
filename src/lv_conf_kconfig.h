...
#elif defined (CONFIG_LV_USE_CHIBIOS_MALLOC)
#  define CONFIG_LV_USE_STDLIB_MALLOC LV_STDLIB_CHIBIOS
...
#elif defined (CONFIG_LV_USE_CHIBIOS_SPRINTF)
#  define CONFIG_LV_USE_STDLIB_SPRINTF LV_STDLIB_CHIBIOS
